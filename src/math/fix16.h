...
#	define F16(x)	((float)(x))
	static inline fix16_t fix16_from_int(int x)	{ return (float)x; };
	static inline fix16_t fix16_from_float(float x)	{ return x; };
	static inline fix16_t fix16_to_float(fix16_t x)	{ return x; };
	static inline int fix16_to_int(fix16_t x){ return (int)x; };

	static inline fix16_t fix16_mul(fix16_t x, fix16_t y)	{ return x * y; };
	static inline fix16_t fix16_add(fix16_t x, fix16_t y)	{ return x + y; };
	static inline fix16_t fix16_div(fix16_t x, fix16_t y)	{ return x / y; };
	static inline fix16_t fix16_sub(fix16_t x, fix16_t y)	{ return x - y; };
	static inline fix16_t fix16_abs(fix16_t x)	{ return fabsf(x); };

	float fix16_sqrt(float x);
	float fix16_cos(float x);
	float fix16_sin(float x);
#endif
